...
TOOL_DEFINITION = {
    ...
    "function": {
        ...
        "description": "Retorna o horário exato e atual do servidor da Syndra. Use APENAS quando o usuário perguntar explicitamente a hora ou data de hoje.",
        "parameters": {
            "type": "object",
            "properties": {},
            "required": []
